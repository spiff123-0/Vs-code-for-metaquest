...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    AndroidDirectoryPickerBridge androidDirectoryPickerBridge;
...
//       TODO     swipeRefreshLayout.onConfigurationChanged(newConfig);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (androidDirectoryPickerBridge != null
                && androidDirectoryPickerBridge.handleActivityResult(requestCode, resultCode, data)) {
            return;
        }
        GoNativeApplication application = (GoNativeApplication)getApplication();
