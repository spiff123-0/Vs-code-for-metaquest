...
public class WebViewSetup {
    ...
    public static void setupWebviewForActivity(GoNativeWebviewInterface webview, MainActivity activity) {
        ...
        activity.androidDirectoryPickerBridge = new AndroidDirectoryPickerBridge(activity);
        wv.removeJavascriptInterface("AndroidDirectoryPicker");
        wv.addJavascriptInterface(activity.androidDirectoryPickerBridge, "AndroidDirectoryPicker");
